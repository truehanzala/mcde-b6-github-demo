--Assignment 1 — Basic SELECT & Filtering
...
-- Task 6:  Find all products priced between 500 and 1500. Hint: Use the BETWEEN operator.
SELECT *
FROM production.products
WHERE list_price BETWEEN 500 AND 1500;

-- Task 7:  List all distinct cities where customers are located.Hint: Use SELECT DISTINCT.
SELECT DISTINCT city
FROM sales.customers;


-- Task 8:  Find all orders that have NOT been shipped yet. Hint: Filter where shipped_date IS NULL.
